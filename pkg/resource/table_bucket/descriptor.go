...
const (
	FinalizerString = "finalizers.s3tables.services.k8s.aws/TableBucket"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("tablebuckets")
	GroupKind            = metav1.GroupKind{
		Group: "s3tables.services.k8s.aws",
		Kind:  "TableBucket",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.TableBucket{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TableBucket),
	}
}
