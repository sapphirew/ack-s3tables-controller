...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f1, f1ok := identifier.AdditionalKeys["namespace"]
	if f1ok {
		r.ko.Spec.Namespace = aws.String(f1)
	}
	f3, f3ok := identifier.AdditionalKeys["tableBucketARN"]
	if f3ok {
		r.ko.Spec.TableBucketARN = aws.String(f3)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f1, f1ok := fields["namespace"]
	if f1ok {
		r.ko.Spec.Namespace = aws.String(f1)
	}
	f3, f3ok := fields["tableBucketARN"]
	if f3ok {
		r.ko.Spec.TableBucketARN = aws.String(f3)
	}
