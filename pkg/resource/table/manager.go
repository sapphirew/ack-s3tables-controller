...
// +kubebuilder:rbac:groups=s3tables.services.k8s.aws,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3tables.services.k8s.aws,resources=tables/status,verbs=get;update;patch
