...
// +kubebuilder:rbac:groups=s3tables.services.k8s.aws,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3tables.services.k8s.aws,resources=namespaces/status,verbs=get;update;patch
