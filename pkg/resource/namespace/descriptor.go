...
const (
	FinalizerString = "finalizers.s3tables.services.k8s.aws/Namespace"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("namespaces")
