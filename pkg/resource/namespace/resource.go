...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f1, f1ok := identifier.AdditionalKeys["tableBucketARN"]
	if f1ok {
		r.ko.Spec.TableBucketARN = aws.String(f1)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f1, ok := fields["tableBucketARN"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: tableBucketARN"))
	}
	r.ko.Spec.TableBucketARN = &f1
